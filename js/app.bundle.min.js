function track(e,o){var a=new Date,r=a.getDate()+"_"+a.getMonth()+"_"+a.getFullYear(),t="https://fiery-torch-1756.firebaseio.com/errorlogs/"+r,n=new Firebase(t);o.platform=log_currentPlatform,o.platformVersion=log_currentPlatformVersion;try{n.push(o)}catch(c){}}var debug=!0,log_currentPlatform,log_currentPlatformVersion;angular.module("app",["ionic","ngStorage","chart.js","dbaq.ionTimer","ionic-datepicker","ionic-ratings","readinglog.views","app.config","app.GlobalConfig","app.services","app.modules"]).config(["$provide",function(e){e.decorator("$exceptionHandler",["$delegate",function(e){return function(o,a){e(o,a);var r={url:window.location.hash};a&&(r.cause=a),o&&(o.message&&(r.message=o.message),o.name&&(r.name=o.name),o.stack&&(r.stack=o.stack)),debug?console.log("exception",r):track("exception",r)}}])}]).run(["$rootScope","$state","$ionicPlatform","appUserService","appFireBaseAuthService","$timeout",function(e,o,a,r,t,n){e.$broadcast("app-started-or-resumed")}]),window.onerror=function(e,o,a,r,t){var n=debug?!1:!0,c={url:window.location.hash};return e&&(c.message=e),o&&(c.fileName=o),a&&(c.lineNumber=a),r&&(c.columnNumber=r),t&&(t.name&&(c.name=t.name),t.stack&&(c.stack=t.stack)),debug?console.log("exception",c):track("exception",c),n};
...
!function(){"use strict";function e(e,t,o){function i(){var r,t=e.defer();return r=l.getAuth(),!r&&f?o.logIn({email:f.email,password:f.accesscode},function(e,r){n(r,t)}):r?n(r,t):t.resolve([]),t.promise}function n(e,r){var t,o=h.child(e.uid),i=[];o.once("value",function(e){return e.exists()?(e.forEach(function(e){t=angular.extend(e.val(),{key:e.key()}),t.$$hashKey&&delete t.$$hashKey,i.push(t)}),void r.resolve(i)):(r.resolve(i),r.promise)},function(){r.resolve(i)})}function u(e,r){if(c=l.getAuth(),!c)return void r("error: user not set");var t=h.child(c.uid);t.push(e,r)}function s(e,r){if(c=l.getAuth(),!c)return void r("error: user not set");var t=h.child(c.uid),o=t.child(e.key),i={authors:e.authors,dateRead:e.dateRead,description:e.description,genre:e.genre,notes:e.notes,rating:e.rating,readingSel:e.readingSel,smThumbnail:e.smThumbnail,timeRead:e.timeRead,title:e.title};o.update(i,r)}function a(e,r){if(c=l.getAuth(),!c)return void r("error: user not set");var t=h.child(c.uid),o=t.child(e.key);o.remove(r)}var c,d=this,l=new Firebase(r),h=new Firebase(r+"booklogs"),g={},f=t.currentUser;d.setCurrentBookEdit=function(e){g=e},d.getCurrentBookEdit=function(){return g},d.getBookDescription=function(e){return e&&e.length>500?e.substring(0,500)+"...":e},d.getBookAuthors=function(e){return e&&Array.isArray(e)?e.join(","):e},d.getBookLogsByUser=i,d.addBookLog=u,d.editBookLog=s,d.removeBookLog=a}var r="https://fiery-torch-1756.firebaseio.com/";angular.module("app.fireBaseBookService",[]).service("appFireBaseBookService",e),e.$inject=["$q","$localStorage","appFireBaseAuthService"]}();
...
!function(){"use strict";function e(e,t,n,o){function s(r){if(!r||!r.email)throw"email should be supplied when update user info";var n=e.defer(),s=r.email,a=p.getAuth(),c=u(s),l=t.currentUser;return!a&&l?o.logIn({email:l.email,password:l.accesscode},function(e,t){i(t,c,r,n)}):a?i(a,c,r,n):n.resolve(),n.promise}function i(e,r,t,o){var s=p.child("students").child(r);s.update(t,function(){n.alert({title:"Great",template:"Thanks! You are fantastic"}),o.resolve()})}function a(e){return e.auth&&e.auth.provider&&"anonymous"===e.auth.provider}function u(e){var r=e.indexOf("@"),t=e.substr(0,r).replace(".","_");return t}function c(t){if(!t)throw"email empty "+t+" or callback function invalid";var n=e.defer(),o=u(t),s=new Firebase(r+"/students"),i=s.child(o);return i.once("value",function(e){if(!e.exists())return n.reject("user not found"),n.promise;var r=e.val();return n.resolve(r),n.promise}),n.promise}function l(){var r=t.currentUser,n=this.getAuth(),s=e.defer();return n?r?("password"===n.provider?n.password&&n.password.email!==r.email?o.logIn({email:r.email,password:r.accesscode},function(e,r){d(e,r,s)}):s.resolve():"anonymous"===n.provider?o.logIn({email:r.email,password:r.accesscode},function(e,r){d(e,r,s)}):s.resolve(),s.promise):(null===r&&"anonymous"!==n.provider?(o.authAnonymously(),s.resolve()):s.resolve(),s.promise):(r?o.logIn({email:r.email,password:r.accesscode},function(e,r){d(e,r,s)}):(o.authAnonymously(),s.resolve()),s.promise)}function d(e,r,t){if(e)throw t.reject(),e;t.resolve()}var f=this,p=new Firebase(r);f.setDefaultAvartar=function(e){e&&e.avartar&&e.avartar.indexOf("data")>=0&&(e.avartar="icon.png")},f.getUserInfo=c,f.saveUserInfo=function(e){return s(e)},f.storeCurentUserToLocal=function(e){e&&!e.displayName&&(e.displayName=e.username),this.currentUser=t.currentUser=e},f.storeUserListToLocal=function(e){this.readingLogUserList=t.readingLogUserList=e},f.isUserAuthenticated=function(){var e=p.getAuth();return null!==e},f.getAuth=function(){return p.getAuth()},f.isInAnonymousMode=a,f.currentUser=t.currentUser,f.readingLogUserList=t.readingLogUserList,f.restoreCurrentAuth=l}var r="https://fiery-torch-1756.firebaseio.com";angular.module("app.userService",[]).service("appUserService",e),e.$inject=["$q","$localStorage","$ionicPopup","appFireBaseAuthService"]}();
!function(){"use strict";function e(e,o,s,n,r,t,c){function a(e,o){null===e&&o&&o.uid?u(o):f(e)}function u(e){r.clearCache(),g.addExistingUser?t.getUserInfo(g.email).then(i,f):(t.storeCurentUserToLocal(g.accountToSwitch),o.$broadcast("user-changed",g.accountToSwitch),n.go("app.booklogform"))}function i(e){if(!e)throw"user authenticated, however could not find the corresponding user info";e.accesscode||(e.accesscode=g.accesscode),t.storeCurentUserToLocal(e),d(e),o.$broadcast("user-changed",e),n.go("app.booklogform")}function d(e){l(e,g.userList),t.storeUserListToLocal(g.userList),g.username="",g.accesscode="",g.showAdd=!1}function l(e,o){var s,n=[],r=g.userList.length;for(s=0;r>s;s++)n.push(o[s].username.toLowerCase());n.indexOf(e.username.toLocaleLowerCase())<0&&o.push(e)}function f(e){s.alert({title:"Sorry",template:"The account information provided is not valid"})}var g=this,h="readingLogUserList",m=c[h],p=t.currentUser;m||(m=[],c[h]=m),g.userList=m,g.showAdd=!1,p?g.currentUserName=p.username:g.useranonymous=!0,g.showAddAccount=function(){g.showAdd=!g.showAdd},g.removeAccount=function(e){var o,s,n=g.userList,r=g.userList.length;for(o=0;r>o;o++)if(n[o].username===e.username){s=o;break}n.splice(s,1),g.userList=n,c[h]=n},g.goAnonymous=function(){r.signOut(),t.storeCurentUserToLocal(null);var e=r.authAnonymously();e.then(function(){o.$broadcast("user-changed",null),n.go("app.booklogform")},f)},g.doLogin=function(){g.addExistingUser=!0;var e=g.username.indexOf("@")>=0?g.username:g.username.toLowerCase()+"@readinglog.com";g.email=e,r.logIn({email:e,password:g.accesscode},a)},g.switchAccount=function(e){g.addExistingUser=!1,g.accountToSwitch=e;r.logIn({email:e.email,password:e.accesscode},a)}}angular.module("app.accounts",[]).controller("appAccount",e),e.$inject=["$scope","$rootScope","$ionicPopup","$state","appFireBaseAuthService","appUserService","$localStorage"]}();
...
!function(){"use strict";function o(o,e,t,a,n,i,r,s,l,c){function d(o,e){var t=o.alert({title:"Sorry",template:"We have experienced service interruption, please try a few moments later"});t.then(function(o){e.go("app.viewall")})}function m(o,e){var t=o.alert({title:"Woo-hoo",template:"Thanks! We have logged your book"});t.then(function(o){e.go("app.viewall")})}function h(o,e){return{scope:o,backdropClickToClose:!0,animation:"slide-in-up",id:e}}function u(o,e,t){var a=t.constants.ModalTypes;e.fromTemplateUrl("views/modal/stopwatch.html",h(o,a.stopwatch)).then(function(e){o.stopWatchModal=e}),e.fromTemplateUrl("views/modal/timer.html",h(o,a.timer)).then(function(e){o.timerModal=e}),e.fromTemplateUrl("views/modal/timeform.html",h(o,a.timeform)).then(function(e){o.timeFormModal=e}),e.fromTemplateUrl("views/modal/bookscan.html",h(o,a.scan)).then(function(e){o.bookScanModal=e}),e.fromTemplateUrl("views/modal/booksearch.html",h(o,a.search)).then(function(e){o.bookSearchModal=e}),e.fromTemplateUrl("views/modal/bookentry.html",h(o,a.bookform)).then(function(e){o.bookEntryModal=e}),o.$on("$destroy",function(){o.stopWatchModal.remove(),o.timerModal.remove(),o.timeFormModal.remove(),o.bookScanModal.remove(),o.bookSearchModal.remove(),o.bookEntryModal.remove()}),o.$on("modal.shown",function(e,t){switch(t.id){case a.scan:o.$broadcast("scan-modal-shown");break;case a.stopwatch:o.$broadcast("stopwatch-shown");break;case a.timer:o.$broadcast("timer-shown")}})}function g(o,e,t){switch(e){case t.timer:o.timerModal.show();break;case t.stopwatch:o.stopWatchModal.show();break;case t.timeform:o.timeFormModal.show();break;case t.scan:o.bookScanModal.show();break;case t.search:o.bookSearchModal.show();break;case t.bookform:o.bookEntryModal.show()}}var b=this,p=i.constants.ModalTypes,f=c.currentUser;if(b.isMobileApp=window.isMobileApp,b.isEditing=s.edit,b.readingHow=1,b.genre="NF",b.notes="",u(o,t,i),f||(b.useranonymous=!0),b.showModal=function(e){g(o,e,p)},b.bookCategories=i.genres,b.readWays=i.readWays,b.modalTypes=p,b.ratingsObject={iconOn:"ion-ios-star",iconOff:"ion-ios-star-outline",iconOnColor:"rgb(200, 200, 100)",iconOffColor:"rgb(200, 100, 100)",rating:0,minRating:1,callback:function(o){b.rating=o}},"true"===b.isEditing){var k=n.getCurrentBookEdit();b.readingTimeStats={timeRead:k.timeRead,date:k.dateRead},b.book={title:k.title,authors:k.authors,smThumbnail:k.smThumbnail,description:k.description},b.authorStr=n.getBookAuthors(k.authors),b.genre=k.genre||"NF",b.rating=k.rating||1,b.readingHow=k.readingSel||1,b.ratingsObject.rating=b.rating,b.notes=k.notes||""}else b.readingTimeStats={timeRead:0,date:(new Date).toDateString()};o.setBookInfo=function(o,e,t){o=o||{title:e,authors:t},b.book=o,b.authorStr=n.getBookAuthors(o.authors)},o.setReadingTimeInfo=function(o,e,t){var a=e||0;b.readingTimeStats={timeRead:60*a+o,date:t?t.toDateString():(new Date).toDateString()}},b.onSubmit=function(){var o;if(null!==b.book&&b.book&&b.book.title&&b.book.title.length>0&&null!==b.readingTimeStats&&b.readingTimeStats.timeRead>0&&(o={title:b.book.title,authors:b.book.authors||"",smThumbnail:b.book.smThumbnail||"img/image-missing-md.png",description:n.getBookDescription(b.book.description)||"",dateRead:b.readingTimeStats.date||new Date,timeRead:b.readingTimeStats.timeRead||0,genre:b.genre||"NF",rating:b.rating||1,readingSel:b.readingHow||1,notes:b.notes}),!o){var t=a.alert({title:"Please set the book title and minutes you have read",template:"You probably forgot?"});return t.then(function(o){}),!1}c.restoreCurrentAuth().then(function(){if(b.isEditing){var t=angular.extend(k,o);"undefined"==typeof t.authorStr&&(t.authorStr=""),n.editBookLog(t,function(o){return o?(d(a,r),!1):(l.clearCache(),e.$broadcast("book-logged"),m(a,r))})}else n.addBookLog(o,function(o){return o?(d(a,r),!1):(l.clearCache(),e.$broadcast("book-logged"),m(a,r))})})}}angular.module("app.readnow",[]).controller("appReadNow",o),o.$inject=["$scope","$rootScope","$ionicModal","$ionicPopup","appFireBaseBookService","appGlobalConfigService","$state","$stateParams","$ionicHistory","appUserService"]}();
...
!function(){"use strict";function n(n,a,e,i){var o=this,r=e.currentUser;r.displayName||(r.displayName=r.username),o.showPicker=!1,o.avartars=["animal-icon-cow.png","animal-icon-crab.png","animal-icon-dog.png","animal-icon-donkey.png","animal-icon-frog.png","animal-icon-gold-fish.png","animal-icon-horse.png","animal-icon-jellyfish.png","animal-icon-kitten-cat.png","animal-icon-mouse.png","animal-icon-octopus.png","animal-icon-puppy-dog.png","animal-icon-shark.png","animal-icon-squirrel.png","animal-icon-tuna-blue-fish.png"],o.setCurrentUserInfo=function(n){o.user=n},r||(o.useranonymous=!0),o.user=r,o.saveUserInfo=function(){var n={displayName:o.user.displayName,username:o.user.username,email:o.user.email,avartar:o.user.avartar||"icon.png"};e.saveUserInfo(n).then(function(){a.$broadcast("user-changed",o.user),i.go("app.booklogform")})},o.toggleImagePicker=function(){o.showPicker=!o.showPicker},o.setAvartar=function(n){o.user.avartar=n,o.showPicker=!1}}angular.module("app.settings",[]).controller("appSettings",n),n.$inject=["$scope","$rootScope","appUserService","$state"]}();
!function(){"use strict";function e(e,t,o,n){function a(){t.restoreCurrentAuth().then(r())}function r(){o.getBookLogsByUser().then(s,u)}function s(e){var t,o=[],n=e.length;for(t=0;n>t;t++)o.indexOf(e[t].title)<0&&o.push(e[t].title);i.totalBooks=o.length}function u(){i.totalBooks=0}var i=this,l=t.currentUser;i.totalBooks=0,l&&(l.displayName||(l.displayName=l.username),t.setDefaultAvartar(l)),i.user=l,e.$on("user-changed",function(e,o){o&&!o.displayName&&(o.displayName=o.username),t.setDefaultAvartar(o),r(),i.user=o}),e.$on("book-logged",r),e.$on("app-started-or-resumed",a),a()}angular.module("app.sidemenu",[]).controller("appSideMenu",e),e.$inject=["$scope","appUserService","appFireBaseBookService","$timeout"]}();
!function(){"use strict";function e(e,t,n,r,a,o){function u(e){return e.reduce(function(e,t){return e.indexOf(t)<0&&e.push(t),e},[])}function s(e){var t,n=p.length,r=[];for(t=0;n>t;t++){var a=i(p[t],e);null!==a&&r.push(a)}return r}function i(e,t){var n=t.filter(function(t){return t.genre===e.value});if(n.length>0){var r=n.map(function(e){return e.timeRead}),a=r.reduce(function(e,t){return e+t});return{name:e.value,minutes:a}}return null}function l(e){var t,n,r,a,o=e.length,s=e.map(function(e){return new Date(e.dateRead)}),i=[];if(s=u(s),"weekly"===g.mode?a=g.weekselected:"monthly"===g.mode&&(a=g.monthselected),a){n=a.startDate,r=a.endDate,s=[n];for(var l=new Date(n.getTime());r>l;)s.push(new Date(l.setDate(l.getDate()+1)))}for(o=s.length,t=0;o>t;t++){var f=s[t],d=c(f,e);i.push(d)}return{dates:s,time:i}}function c(e,t){var n=0,r=t.filter(function(t){return new Date(t.dateRead).setHours(0,0,0,0)==e.setHours(0,0,0,0)});if(r&&r.length>0){var a=r.map(function(e){return e.timeRead});n=a.reduce(function(e,t){return e+t})}return n}function f(e){if(g.allBooksRead=e,!e||!e.length)return void h([]);var t=new Date(e[0].dateRead);d(t),h(e)}function d(e){g.weeks=r.getLastTwelveWeeks(e),g.months=r.getLastSixMonths(e),g.weeks.length>0&&(g.weekselected=g.weeks[0]),g.months.length>0&&(g.monthselected=g.months[0])}function h(e){if(0!==e.length){var t=e;g.books=t;var n=s(t),r=n.map(function(e){return e.name}),o=n.map(function(e){return e.minutes});g.chartGenreData={labels:r,data:[o]};var u=l(t),i=u.dates.map(function(e){return a("date")(e,"MM/dd")}),c=Math.floor(i.length/10),f=[];if(c>=1)for(var d=0;d<i.length;d++)d%c===0&&f.push(i[d]);else f=i;g.chartReadingData={labels:f,data:[u.time]}}}function m(e){throw e}var g=this,p=n.genres;o.currentUser;g.mode="weekly",e.$on("newbooklogged",function(e,t){g.allBooksRead=t,h(t)}),o.restoreCurrentAuth().then(function(){t.getBookLogsByUser().then(f,m)}),g.setTimeMode=function(e){g.mode=e,g.rechart()},g.rechart=function(){var e,t,n,r,a,o=angular.copy(g.allBooksRead);e="weekly"===g.mode?g.weekselected:g.monthselected,e&&(t=e.startDate,n=e.endDate,r=o.filter(function(e){return a=e?new Date(e.dateRead).setHours(0,0,0,0):new Date,a>=t.setHours(0,0,0,0)&&a<=n.setHours(0,0,0,0)}),h(r))}}angular.module("app.stats",[]).controller("appStats",e),e.$inject=["$scope","appFireBaseBookService","appGlobalConfigService","appDateTimeService","$filter","appUserService"]}();
!function(){"use strict";function e(e,t,i,r){function s(e){var t,i,r,s,n,o=e,l=o.length,m=0,u=0,g=[],d=c.awards;for(t=0;l>t;t++)u+=o[t].timeRead,g.indexOf(o[t].genre)<0&&g.push(o[t].genre);m=Math.min(d.tickets.max,Math.floor(l/d.tickets.base)),i=Math.min(d.stickers.max,Math.floor(u/d.stickers.base)),r=g.length,l>d.coins.base&&(s=Math.floor(l/d.coins.base)),u>d.gems.base&&(n=Math.floor(u/d.gems.base)),c.totalLogs=l,c.toalMinutes=u,c.totalGenres=r,c.totalCoins=s,c.totalGems=n,c.stars=a(r,d.stars),c.stickers=a(i,d.stickers),c.tickets=a(m,d.tickets),c.coins=a(s,d.coins),c.gems=a(n,d.gems)}function a(e,t){var i,r=[];for(i=0;e>i;i++)r.push({img:n(i,t.available,t.img),index:i});return r}function n(e,t,i){var r=e%t+1;return i+r+".png"}function o(e){throw e.message}var c=this,l=(i.currentUser,{tickets:{available:6,max:20,base:5,img:"ticket",description:{name:"Ticket",description:"1 ticket = 5 log entries (20mx)"}},stickers:{available:4,max:10,base:60,img:"goodjob",description:{name:"Sticker",description:"1 sticker = 60 minutes of reading (10mx)"}},stars:{available:4,img:"genre",description:{name:"Star",description:"1 star = 1 genre"}},coins:{available:1,img:"coin",base:100,description:{name:"Coin",description:"1 coin = 100 log entries (wow!)"}},gems:{available:5,img:"gem",base:1200,description:{name:"Gem",description:"1 gem = 1200 minutes of reading (wow!)"}}});c.awards=l,c.showSticky=!0,i.restoreCurrentAuth().then(function(){t.getBookLogsByUser().then(s,o)}),r.fromTemplateUrl("views/modal/treasuresticky.html",{scope:e,animation:"slide-in-up"}).then(function(t){e.currentTreasureStickyModal=t}),e.openCurrentTreasureStickyModal=function(){e.currentTreasureStickyModal.show()},e.closeCurrentTreasureStickyModal=function(){e.currentTreasureStickyModal.hide()},e.$on("$destroy",function(){e.currentTreasureStickyModal.remove()})}angular.module("app.treasure",[]).controller("appTreasure",e),e.$inject=["$scope","appFireBaseBookService","appUserService","$ionicModal"]}();
!function(){"use strict";function o(o,e,n,t,r,i,a,l,c,u){function s(){a.restoreCurrentAuth().then(function(){r.getBookLogsByUser().then(g,f)})}function g(o){var e=o;if(v&&v.length){k.genreId=v;var n=p.filter(function(o){return h(o,k.genreId)});k.genreName=n&&n.length?n[0].name:"",e=o.filter(function(o){return o.genre===v})}angular.forEach(e,function(o){d(o)}),k.booklogs=e}function f(o){throw o.message}function d(o){if(o){var e=B.filter(function(e){return h(e,o.readingSel)}),n=p.filter(function(e){return h(e,o.genre)});o.authorStr=r.getBookAuthors(o.authors),o.timestamp=new Date(o.dateRead),o.readMannerName=e&&e.length?e[0].name:"Read By Myself",o.genreName=n&&n.length?n[0].name:"Non Fiction"}}function h(o,e){return o.value===e}function m(o){o||s()}var k=this,p=i.genres,B=i.readWays,v=t.genreId;o.$on("newbooklogged",function(o,e){k.allBooksRead=e;try{g(e)}catch(n){k.error=n.message}}),u.fromTemplateUrl("views/modal/booklogdetails.html",{scope:o,animation:"slide-in-up"}).then(function(e){o.currentBookLogDetailsModal=e}),o.openCurrentBookLogDetailsModal=function(){o.currentBookLogDetailsModal.show()},o.closeCurrentBookLogDetailsModal=function(){o.currentBookLogDetailsModal.hide()},o.$on("$destroy",function(){o.currentBookLogDetailsModal.remove()}),k.showLogDetails=function(e){o.currentBookLog=e,o.openCurrentBookLogDetailsModal()},k.showFilterBar=function(){k.filterBarInstance=l.show({items:k.booklogs,update:function(o,e){k.booklogs=o}})},k.editLog=function(o){c.clearCache(),r.setCurrentBookEdit(o),e.go("app.booklogform",{edit:!0},{reload:!0})},k.removeLog=function(o){r.removeBookLog(o,m),n.$broadcast("book-logged")},k.init=s,k.init()}angular.module("app.viewall",["jett.ionic.filter.bar"]).controller("appViewAll",o),o.$inject=["$scope","$state","$rootScope","$stateParams","appFireBaseBookService","appGlobalConfigService","appUserService","$ionicFilterBar","$ionicHistory","$ionicModal"]}();
!function(){"use strict";function e(e,t,a,n,r,o,i,s){function l(e){e!==k.timeFrame&&u(e)}function u(e){var a,n,r,o=new Date,s=o.getDay();k.timeFrame=e,e===v.lastWeek&&k.earliestDate?(a=i.getLastWeekDates(k.earliestDate),a&&(n=0===s?a.startDate.addDays(-6):a.startDate.addDays(1),k.timeDescription="Week Of "+t("date")(n,S))):(r=i.getLastSevenDays(),n=r.startDate,k.timeDescription=t("date")(n,S)+" to "+t("date")(r.endDate,S)),d(n,k.books||[])}function d(e,a){var n,r,o,i=[],s=[],l=["Sun","Mon","Tues","Wed","Thurs","Fri","Sat"],u=0;for(k.booklogs=a,n=0;7>n&&(r=e.addDays(n),!(r>=new Date));n++)o=r.getDay(),i=c(a,r),i.length&&(u+=m(i)),i=i.map(p),0===i.length&&i.push({title:"",nonStarsArr:5,starsArr:0}),s.push({name:l[o],date:t("date")(r,S),books:i});k.booksReadWeekly=s,k.totalminutes=u}function g(e){var t=e;if(t&&t.length){var a=new Date(e[0].dateRead);k.earliestDate=a,k.books=e,u(k.timeFrame)}}function c(e,t){return e.filter(function(e){return new Date(e.dateRead).setHours(0,0,0,0)===t.setHours(0,0,0,0)})}function m(e){var t,a=0,n=e?e.length:0;for(t=0;n>t;t++)a+=e[t].timeRead;return a}function p(e){var t=e.readingSel?f(k.readWays,e.readingSel):k.readWays;return e.howIRead=t?t.name:k.readWays[0].name,e.starsArr=new Array(e.rating),e.nonStarsArr=new Array(5-e.rating),e.authors=n.getBookAuthors(e.authors),e}function f(e,t){var a=e.filter(function(e){return y(e,t)});return a.length>0?a[0]:e[0]}function y(e,t){return e.value===t}function D(e){throw e.message}function h(e){e.alert({title:"Email sent",template:"It may take a minute or 2 reaching your inbox. Try not to let it run into your spam box :)"})}var k=this,v={lastSevenDays:"last7days",lastWeek:"lastWeek"},S="MM/dd/yy",W=o.currentUser;k.isMobileApp=!(window.location.origin.indexOf("http")>=0||window.location.origin.indexOf("https")>=0),k.genres=r.genres,k.readWays=r.readWays,k.timeFrame=v.lastSevenDays,o.restoreCurrentAuth().then(function(){W?(k.username=W.username,k.parentEmail=W.parentemail,n.getBookLogsByUser().then(g,D)):n.getBookLogsByUser().then(g,D)}),k.sendEmail=function(){if(k.parentEmail&&k.parentEmail.length){var e=document.getElementById("print-log").innerHTML;e=e.replace(/img/g,"http://readinglogapp.net/img"),s.sendEmail({MailTo:k.parentEmail,Subject:"Weekly Reading Report for "+k.username,Body:e}).then(function(){h(a)})}},k.getLogFor7Days=function(){l(v.lastSevenDays)},k.getLogForLastWeek=function(){l(v.lastWeek)}}angular.module("app.weeklylog",[]).controller("appWeeklyLog",e),e.$inject=["$scope","$filter","$ionicPopup","appFireBaseBookService","appGlobalConfigService","appUserService","appDateTimeService","appEmailService"]}();
...
!function(){"use strict";function o(o,c,e,a,n){}angular.module("app.bookscan",["app.services"]).controller("appBookScan",o),o.$inject=["$scope","$cordovaBarcodeScanner","$ionicPlatform","appGlobalConfigService","GoogleApiService"]}();
