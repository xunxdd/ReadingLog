function track(o,e){var n=new Date,r=n.getDate()+"_"+n.getMonth()+"_"+n.getFullYear(),a="https://fiery-torch-1756.firebaseio.com/errorlogs/"+r,i=new Firebase(a);e.platform=log_currentPlatform,e.platformVersion=log_currentPlatformVersion,i.push(e)}var debug=!1,log_currentPlatform,log_currentPlatformVersion;angular.module("app",["ionic","ngStorage","chart.js","dbaq.ionTimer","ionic-datepicker","ionic-ratings","readinglog.views","app.config","app.GlobalConfig","app.services","app.modules"]).config(["$provide",function(o){o.decorator("$exceptionHandler",["$delegate",function(o){return function(e,n){o(e,n);var r={url:window.location.hash};n&&(r.cause=n),e&&(e.message&&(r.message=e.message),e.name&&(r.name=e.name),e.stack&&(r.stack=e.stack)),debug?console.log("exception",r):track("exception",r)}}])}]).run(["$rootScope","$state","$ionicPlatform","appUserService","appFireBaseAuthService","$timeout",function(o,e,n,r,a,i){function t(){var o=r.currentUser,e=r.getAuth();e?o?"password"===e.provider&&e.password&&e.password.email!==o.email&&a.logIn({email:o.email,password:o.accesscode},c):null===o&&"anonymous"!==e.provider&&a.authAnonymously():o?a.logIn({email:o.email,password:o.accesscode},c):a.authAnonymously()}function c(o,e){if(o)throw o}function s(){o.$on("$stateChangeStart",function(o,e,n,r,a){t()})}document.addEventListener("visibilitychange",function(){"visible"===document.visibilityState&&"app.booklogform"!==e.current.name&&e.go("app.booklogform")},!1),window.isMobileApp=!(window.location.origin.indexOf("http")>=0||window.location.origin.indexOf("https")>=0),s(),n.ready(function(){document.addEventListener("resume",function(o){"app.booklogform"!==e.current.name?e.go("app.booklogform"):t()}),log_currentPlatform=ionic.Platform.platform(),log_currentPlatformVersion=ionic.Platform.version(),window.cordova&&window.cordova.plugins.Keyboard&&cordova.plugins.Keyboard.hideKeyboardAccessoryBar(!0),window.StatusBar&&(StatusBar.overlaysWebView(!1),ionic.Platform.fullScreen()),ionic.Platform.isFullScreen=!0}),n.registerBackButtonAction(function(o){navigator.app.backHistory()},100)}]),window.onerror=function(o,e,n,r,a){var i=debug?!1:!0,t={url:window.location.hash};return o&&(t.message=o),e&&(t.fileName=e),n&&(t.lineNumber=n),r&&(t.columnNumber=r),a&&(a.name&&(t.name=a.name),a.stack&&(t.stack=a.stack)),debug?console.log("exception",t):track("exception",t),i};
...
!function(){"use strict";function e(e,t,n){function i(r){if(!r||!r.email)throw"email should be supplied when update user info";var t=e.defer(),i=r.email,s=c.getAuth(),o=a(i);if(s){var u=c.child("students").child(o);u.update(r,function(){n.alert({title:"Great",template:"Thanks! You are fantastic"}),t.resolve()})}else t.reject("Ah, this user does not seem to exist");return t.promise}function s(e){return e.auth&&e.auth.provider&&"anonymous"===e.auth.provider}function a(e){var r=e.indexOf("@"),t=e.substr(0,r).replace(".","_");return t}function o(t){if(!t)throw"email empty "+t+" or callback function invalid";var n=e.defer(),i=a(t),s=new Firebase(r+"/students"),o=s.child(i);return o.once("value",function(e){if(!e.exists())return n.reject("user not found"),n.promise;var r=e.val();return n.resolve(r),n.promise}),n.promise}var u=this,c=new Firebase(r);u.setDefaultAvartar=function(e){e&&e.avartar&&e.avartar.indexOf("data")>=0&&(e.avartar="icon.png")},u.getUserInfo=o,u.saveUserInfo=function(e){return i(e)},u.storeCurentUserToLocal=function(e){this.currentUser=t.currentUser=e},u.storeUserListToLocal=function(e){this.readingLogUserList=t.readingLogUserList=e},u.isUserAuthenticated=function(){var e=c.getAuth();return null!==e},u.getAuth=function(){return c.getAuth()},u.isInAnonymousMode=s,u.currentUser=t.currentUser,u.readingLogUserList=t.readingLogUserList}var r="https://fiery-torch-1756.firebaseio.com";angular.module("app.userService",[]).service("appUserService",e),e.$inject=["$q","$localStorage","$ionicPopup"]}();
...
!function(){"use strict";function n(n,a,i){var o=this,e=a.currentUser;o.showPicker=!1,o.avartars=["animal-icon-cow.png","animal-icon-crab.png","animal-icon-dog.png","animal-icon-donkey.png","animal-icon-frog.png","animal-icon-gold-fish.png","animal-icon-horse.png","animal-icon-jellyfish.png","animal-icon-kitten-cat.png","animal-icon-mouse.png","animal-icon-octopus.png","animal-icon-puppy-dog.png","animal-icon-shark.png","animal-icon-squirrel.png","animal-icon-tuna-blue-fish.png"],o.setCurrentUserInfo=function(n){o.user=n},e||(o.useranonymous=!0),o.user=e,o.saveUserInfo=function(){var e={username:o.user.username,email:o.user.email,avartar:o.user.avartar||"icon.png"};a.saveUserInfo(e).then(function(){n.$broadcast("user-changed",o.user),i.go("app.booklogform")})},o.toggleImagePicker=function(){o.showPicker=!o.showPicker},o.setAvartar=function(n){o.user.avartar=n,o.showPicker=!1}}angular.module("app.settings",[]).controller("appSettings",n),n.$inject=["$rootScope","appUserService","$state"]}();
!function(){"use strict";function e(e,r){var t=this,n=r.currentUser;n&&r.setDefaultAvartar(n),t.user=n,e.$on("user-changed",function(e,n){r.setDefaultAvartar(n),t.user=n})}angular.module("app.sidemenu",[]).controller("appSideMenu",e),e.$inject=["$scope","appUserService"]}();
...
!function(){"use strict";function e(e,n,o,t,r,i,a){function l(){t.getBookLogsByUser().then(c,u)}function c(e){var n=e;if(p&&p.length){d.genreId=p;var o=m.filter(function(e){return f(e,d.genreId)});d.genreName=o&&o.length?o[0].name:"",n=e.filter(function(e){return e.genre===p})}angular.forEach(n,function(e){g(e)}),d.booklogs=n}function u(e){throw e.message}function g(e){if(e){var n=h.filter(function(n){return f(n,e.readingSel)}),o=m.filter(function(n){return f(n,e.genre)});e.authorStr=t.getBookAuthors(e.authors),e.timestamp=new Date(e.dateRead),e.readMannerName=n&&n.length?n[0].name:"Read By Myself",e.genreName=o&&o.length?o[0].name:"Non Fiction"}}function f(e,n){return e.value===n}function s(e){e||l()}var d=this,m=r.genres,h=r.readWays,p=o.genreId;e.$on("newbooklogged",function(e,n){d.allBooksRead=n;try{c(n)}catch(o){d.error=o.message}}),d.showFilterBar=function(){d.filterBarInstance=i.show({items:d.booklogs,update:function(e,n){d.booklogs=e}})},d.editLog=function(e){a.clearCache(),t.setCurrentBookEdit(e),n.go("app.booklogform",{edit:!0},{reload:!0})},d.removeLog=function(e){t.removeBookLog(e,s)},d.init=l,d.init()}angular.module("app.viewall",["jett.ionic.filter.bar"]).controller("appViewAll",e),e.$inject=["$scope","$state","$stateParams","appFireBaseBookService","appGlobalConfigService","$ionicFilterBar","$ionicHistory"]}();
