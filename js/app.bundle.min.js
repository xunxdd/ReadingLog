...
!function(){"use strict";function n(n){function i(n,i,e){i.on("click",function(){var n=document.getElementById(e.printElementId);n&&t(n)}),window.onafterprint=function(){o.innerHTML=""}}function t(i){var t=i.cloneNode(!0);o.appendChild(t),e&&n.isAvailable()?n.print(o,{name:"readinglog.pdf",landscape:!0},function(){o.innerHTML=""}):window.print()}var e=!(window.location.origin.indexOf("http")>=0||window.location.origin.indexOf("https")>=0),o=document.getElementById("printSection");return o||(o=document.createElement("div"),o.id="printSection",document.body.appendChild(o)),{link:i,restrict:"A"}}angular.module("app.print",[]).directive("ngPrint",n),n.$inject=["$cordovaPrinter"]}();
...
!function(){"use strict";function e(){function e(e){return e.getMonth()+1+"/"+e.getDate()+"/"+e.getFullYear().toString().substring(2,4)}function t(t,a,n){switch(t){case 0:return"This "+n;case 1:return"Last "+n;default:return("week"==n?"Week":"Month")+" Of "+e(a)}}function a(e){var t=n(e);return t.length>1?t[1]:null}function n(e){var a,n=new Date,r=n.getDay(),s=new Date((new Date).setDate(n.getDate()-r)),i=[];for(a=0;D>a;a++){var u=s.getTime(),g=new Date(new Date(u).setDate(s.getDate()-7*a)),o=new Date(new Date(g.getTime()).setDate(g.getDate()+6)),w=e>=g;if(i.push({name:t(a,g,"week"),startDate:w?e:g,endDate:o>n?n:o}),w)break}return i}function r(e){var a,n=new Date,r=n.getMonth(),s=n.getFullYear(),D=[];for(a=0;i>a;a++){var u=new Date(s,r,1,0,0,0),g=new Date(u.setMonth(r-a)),o=new Date(new Date(g.getTime()).setMonth(g.getMonth()+1)-1),w=e>=g;if(D.push({name:t(a,g,"month"),startDate:w?e:g,endDate:o>n?n:o}),w)break}return D}var s=this,D=12,i=6;s.getLastSixMonths=r,s.getLastTwelveWeeks=n,s.getLastWeekDates=a}angular.module("app.dateTimeService",[]).service("appDateTimeService",e)}();
...
!function(){"use strict";function e(e,a,t,s,n,c){var u=this;u.grades=n.grades,u.schools=n.schools,u.school=u.schools[0],u.teachers=r(u.schools,u.school),u.setSchoolTeachers=function(){u.teachers=r(u.schools,u.school)},u.setCurrentUserInfo=function(e){null!==e&&(u.user=e,u.school=o(u.schools,e.school),u.teachers=r(u.schools,u.school),u.teacher=o(u.teachers,e.teacher))},s.getUserInfo().then(function(e){u.setCurrentUserInfo(e)}),u.saveUserInfo=function(){var r={username:u.user.username,grade:u.user.grade||"other",parentemail:u.user.parentemail,parentphone:u.user.parentphone||""};u.school&&u.school.value&&(r.school=u.school.value),u.teacher&&u.teacher.value&&(r.teacher=u.teacher.value),s.saveUserInfo(r).then(function(){e.$broadcast("user-changed",u.user.username),c.go("app.booklogform")})},u.selectImage=function(){var r={maximumImagesCount:1,width:200,height:200,quality:80};window.imagePicker.getPictures(function(r){var o;return r&&r.length>0?(o=r[0],void t.crop({url:o,width:100,height:100}).then(function(r){var o=r.toDataURL();s.saveUserAvartar(o),u.user.avartar=o,e.$broadcast("user-avartar-changed",u.user.avartar)},function(){})):!1},function(e){console.log("Error: "+e)},r)}}function r(e,r){if(r&&r.value){var a=o(e,r.value);return a&&a.teachers?a.teachers:[]}return[]}function o(e,r){var o=e.filter(function(e){return e.value==r});return o&&o.length?o[0]:null}angular.module("app.settings",["jrCrop"]).controller("appSettings",e),e.$inject=["$rootScope","$cordovaImagePicker","$jrCrop","appUserService","appGlobalConfigService","$state"]}();
...
!function(){"use strict";function e(e,t,n,a,r){function o(e){var t,n=h.length,a=[];for(t=0;n>t;t++){var r=u(h[t],e);null!==r&&a.push(r)}return a}function u(e,t){var n=t.filter(function(t){return t.genre==e.value});if(n.length>0){var a=n.map(function(e){return e.timeRead}),r=a.reduce(function(e,t){return e+t});return{name:e.value,minutes:r}}return null}function s(e){var t,n,a,r,o=e.length,u=e.map(function(e){return new Date(e.dateRead)}),s=[];if(u=g(u),"weekly"==m.mode?r=m.weekselected:"monthly"==m.mode&&(r=m.monthselected),r){n=r.startDate,a=r.endDate,u=[n];for(var l=new Date(n.getTime());a>l;)u.push(new Date(l.setDate(l.getDate()+1)))}for(o=u.length,t=0;o>t;t++){var c=u[t],d=i(c,e);s.push(d)}return{dates:u,time:s}}function i(e,t){var n=0,a=t.filter(function(t){return new Date(t.dateRead).setHours(0,0,0,0)==e.setHours(0,0,0,0)});if(a&&a.length>0){var r=a.map(function(e){return e.timeRead});n=r.reduce(function(e,t){return e+t})}return n}function l(e){m.allBooksRead=e;var t=new Date(e[0].dateRead);c(t),d(e)}function c(e){m.weeks=a.getLastTwelveWeeks(e),m.months=a.getLastSixMonths(e),m.weeks.length>0&&(m.weekselected=m.weeks[0]),m.months.length>0&&(m.monthselected=m.months[0])}function d(e){0===e.length&&console.log("no books found. cannot chart");var t=e;m.books=t;var n=o(t),a=n.map(function(e){return e.name}),u=n.map(function(e){return e.minutes});m.chartGenreData={labels:a,data:[u]};var i=s(t),l=i.dates.map(function(e){return r("date")(e,"MM/dd/yy")});m.chartReadingData={labels:l,data:[i.time]}}function f(e){console.log(e)}var m=this,h=n.genres;m.mode="weekly",e.$on("newbooklogged",function(e,t){m.allBooksRead=t,d(t)}),t.getBookLogsByUser().$loaded().then(l,f),m.setTimeMode=function(e){m.mode=e,m.rechart()},m.rechart=function(){var e,t,n,a,r,o=angular.copy(m.allBooksRead);e="weekly"==m.mode?m.weekselected:m.monthselected,e&&(t=e.startDate,n=e.endDate,a=o.filter(function(e){return r=new Date(e.dateRead).setHours(0,0,0,0),r>=t.setHours(0,0,0,0)&&r<=n.setHours(0,0,0,0)}),d(a))};var g=function(e){return e.reduce(function(e,t){return e.indexOf(t)<0&&e.push(t),e},[])}}angular.module("app.stats",[]).controller("appStats",e),e.$inject=["$scope","appFireBaseBookService","appGlobalConfigService","appDateTimeService","$filter"]}();
...
!function(){"use strict";function e(e,t,n,a,r,i,o,s){function l(e){var t=e;if(t&&t.length){var n=new Date(e[0].dateRead);u(n,t)}}function u(e,n){var a,r,i,s=o.getLastWeekDates(e),l=[],u=[],m=["Mon","Tues","Wed","Thurs","Fri","Sat","Sun"],g=0;if(s){for(i=s.startDate.addDays(1),f.lastWeekDate=t("date")(i,"MM/dd/yy"),f.booklogs=n,a=0;7>a&&(r=i.addDays(a),!(r>=new Date));a++)u=d(n,r),u.length&&(g+=p(u)),u=u.map(c),0===u.length&&u.push({title:"",nonStarsArr:5,starsArr:0}),l.push({name:m[a],books:u});f.booksReadWeekly=l,f.totalminutes=g}}function d(e,t){return e.filter(function(e){return new Date(e.dateRead).setHours(0,0,0,0)==t.setHours(0,0,0,0)})}function p(e){return 1==e.length?e[0].timeRead:e.reduce(function(e,t){return e.timeRead+t?t.timeRead:0})}function c(e){var t=e.readingSel?f.readWays[e.readingSel]:f.readWays[0];return e.howIRead=t.name,e.starsArr=new Array(e.rating),e.nonStarsArr=new Array(5-e.rating),e}function m(e){throw e.message}function g(e){e.alert({title:"Email sent",template:"It may take a minute or 2 reaching your inbox. Try not to let it run into your spam box :)"})}var f=this;f.isMobileApp=!(window.location.origin.indexOf("http")>=0||window.location.origin.indexOf("https")>=0),f.genres=r.genres,f.readWays=r.readWays,i.getUserInfo().then(function(e){f.username=e.username,f.parentEmail=e.parentemail}),a.getBookLogsByUser().$loaded().then(l,m),f.sendEmail=function(){if(f.parentEmail&&f.parentEmail.length){var e=document.getElementById("print-log").innerHTML;s.sendEmail({MailTo:f.parentEmail,Subject:"Weekly Reading Report for "+f.username,Body:e}).then(function(){g(n)})}}}angular.module("app.weeklylog",[]).controller("appWeeklyLog",e),e.$inject=["$scope","$filter","$ionicPopup","appFireBaseBookService","appGlobalConfigService","appUserService","appDateTimeService","appEmailService"]}();
