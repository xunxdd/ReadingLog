...
!function(){"use strict";function e(e,t,n,a,r,i,o,s){function l(e){var t=e;if(t&&t.length){var n=new Date(e[0].dateRead);u(n,t)}}function u(e,n){var a,r,i,s=o.getLastWeekDates(e),l=[],u=[],c=["Mon","Tues","Wed","Thurs","Fri","Sat","Sun"],m=0;if(s){for(i=s.startDate.addDays(1),f.lastWeekDate=t("date")(i,"MM/dd/yy"),f.booklogs=n,a=0;7>a&&(r=i.addDays(a),!(r>=new Date));a++)u=d(n,r),u.length&&(m+=p(u)),u=u.map(g),0===u.length&&u.push({title:"",nonStarsArr:5,starsArr:0}),l.push({name:c[a],books:u});f.booksReadWeekly=l,f.totalminutes=m}}function d(e,t){return e.filter(function(e){return new Date(e.dateRead).setHours(0,0,0,0)==t.setHours(0,0,0,0)})}function p(e){return 1==e.length?e[0].timeRead:e.reduce(function(e,t){return e.timeRead+t?t.timeRead:0})}function g(e){var t=e.readingSel?f.readWays[e.readingSel]:f.readWays[0];return e.howIRead=t.name,e.starsArr=new Array(e.rating),e.nonStarsArr=new Array(5-e.rating),e}function c(e){throw e.message}function m(e){e.alert({title:"Email sent",template:"It may take a minute or 2 reaching your inbox. Try not to let it run into your spam box :)"})}var f=this;f.isMobileApp=!(window.location.origin.indexOf("http")>=0||window.location.origin.indexOf("https")>=0),f.genres=r.genres,f.readWays=r.readWays,i.getUserInfo().then(function(e){f.username=e.username,f.parentEmail=e.parentemail}),a.getBookLogsByUser().$loaded().then(l,c),f.sendEmail=function(){if(f.parentEmail&&f.parentEmail.length){var e=document.getElementById("print-log").innerHTML;e=e.replace(/img/g,"http://readinglogapp.net/img"),s.sendEmail({MailTo:f.parentEmail,Subject:"Weekly Reading Report for "+f.username,Body:e}).then(function(){m(n)})}}}angular.module("app.weeklylog",[]).controller("appWeeklyLog",e),e.$inject=["$scope","$filter","$ionicPopup","appFireBaseBookService","appGlobalConfigService","appUserService","appDateTimeService","appEmailService"]}();
