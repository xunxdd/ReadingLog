...
!function(){"use strict";function e(e,n,t){var r=this,o=t.constants.GoogleApiSearchType,s=function(e,n){var t="";switch(e){case o.isbn:t=i+"?q=isbn:"+n;break;case o.title:t=i+"?q="+n}return t},a=function(i){var t=n.defer();return e.get(i).then(function(e){t.resolve(e.data)}),t.promise};r.searchTitleOnly=function(e){var i=s(o.title,e);return i+="&maxResults=10&fields=items(volumeInfo)&orderBy=relevance",a(i)},r.search=function(i,t){var r=n.defer(),o=s(i,t);return o+="&maxResults=1&fields=items%2FvolumeInfo&orderBy=relevance",e.get(o).then(function(e){r.resolve(e.data)}),r.promise},r.getBookInfo=function(e){var i=e.volumeInfo,n={title:i.title,link:i.infoLink,smThumbnail:i.imageLinks&&i.imageLinks.smallThumbnail?i.imageLinks.smallThumbnail:"img/image-missing-md.png",description:i.description&&i.description.length>500?i.description.substring(0,500)+"...":i.description,previewLink:i.previewLink,authors:i.authors};return n}}var i="https://www.googleapis.com/books/v1/volumes";angular.module("app.GoogleApiService",[]).service("GoogleApiService",e),e.$inject=["$http","$q","appGlobalConfigService"]}();
